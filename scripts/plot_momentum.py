...
ax.plot(stats1_mc[1:,0]*1e3, stats1_mc[1:,8], color='red', marker = 's', markersize = 2.0 , linewidth=1.0, label=r'MC : $D/\Delta x = 8$' )
ax.plot(stats2_mc[1:,0]*1e3, stats2_mc[1:,8], color='blue', marker = 's', markersize = 2.0, linewidth=1.0, label=r'MC : $D/\Delta x = 16$' )
ax.plot(stats3_mc[1:,0]*1e3, stats3_mc[1:,8], color='green', marker = 's', markersize = 2.0, linewidth=1.0, label=r'MC : $D/\Delta x = 32$' )
ax.plot(stats4_mc[1:,0]*1e3, stats4_mc[1:,8], color='black', marker = 's', markersize = 2.0, linewidth=1.0, label=r'MC : $D/\Delta x = 64$' )

ax.plot(stats1_non[1:,0]*1e3, stats1_non[1:,8], color='red', marker = 'x', markersize = 6.0 , linewidth=1.0, label=r'NON : $D/\Delta x = 8$' )
ax.plot(stats2_non[1:,0]*1e3, stats2_non[1:,8], color='blue', marker = 'x', markersize = 6.0, linewidth=1.0, label=r'NON : $D/\Delta x = 16$' )
ax.plot(stats3_non[1:,0]*1e3, stats3_non[1:,8], color='green', marker = 'x', markersize = 6.0, linewidth=1.0, label=r'NON : $D/\Delta x = 32$' )
ax.plot(stats4_non[1:,0]*1e3, stats4_non[1:,8], color='black', marker = 'x', markersize = 6.0, linewidth=1.0, label=r'NON : $D/\Delta x = 64$' )
